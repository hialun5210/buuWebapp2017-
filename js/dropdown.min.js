 ...
 * 0.9.1(161205)
 */
   var dropload = function(boxid,opition){
         var that = this;
         that.opition={
            page:opition.page||0,
            size:opition.size||10,
            up:opition.up||false,
            down:opition.down||false,
            upcallback:opition.upcallback||null,
            downcallback:opition.downcallback||null
         }
    ...
    $(boxid).dropload({
        ...
        loadUpFn : function(me){
            ...
            if(that.opition.upcallback)
            {
                that.opition.upcallback(me);
            }

         },
         loadDownFn : function(me){
            if(!that.opition.down){$(".dropload-down").hide(); return;}
            that.opition.page++;
            // 拼接HTML
            if(that.opition.downcallback)
            {
                that.opition.downcallback(me,that.opition.page);
            }
